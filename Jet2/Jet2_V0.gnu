...
#----------------------------------------------------
st = '/home/silideng/RunNGA/roundjet/autoign/30atm/diluted/800/stat_13/LFM/alongZ/'
LD = '/home/silideng/RunFM/DME/flamelet/unsteady/diluted/800/LFM/'
...
p st.'zst/species_time.out' u ($1*1000):5 w l ls 1 t '2D-CFD',\
  LD.'profile/sort/zst' u 1:4 w l ls 2 t '1D-LFA'
...
p1D = '/home/silideng/RunNGA/roundjet/autoign/30atm/diluted/800/stat_13/process_E/'
...
set format y "%.1e"
set xtics 50,5,70
set ytics 0,5e10,2e11
unset key

p p1D.'zst/HRR' u ($1/0.0008):2 w l ls 1 t ' '
...
#set format y "%.0f"
set xtics 50,5,70
set ytics 800,300,2e3
unset key

p p1D.'zst/T' u ($1/0.0008):2 w l ls 1 t ' '
...
set xl '$x/D$'
set yl '\vspace{-28pt}$Y_{H}$'
set xr [50:70]
set yr [1e-8:1e-4]
set log y
set format y "%.1e"
set xtics 50,5,70
set ytics 1e-8,10,1e-4
unset key

p p1D.'zst/H' u ($1/0.0008):2 w l ls 1 t ' '
...
set xl '$x/D$'
set yl '\vspace{-28pt}$Y_{OH}$'
set xr [50:70]
set yr [1e-7:1e-3]
set log y
set format y "%.1e"
set xtics 50,5,70
set ytics 1e-7,10,1e-3
unset key

p p1D.'zst/OH' u ($1/0.0008):2 w l ls 1 t ' '
