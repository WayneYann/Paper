...
Uniform grids in the axial direction were adopted for the computations, and the grid spacing was set as $\Delta x = 2.2$ $\mu$m.  \textcolor{r2}{A nonuniform grid was used in the radial direction with a minimum spacing of $2.5$ $\mu$m to resolve the mixing layer corresponding to the separation wall and geometric progression stretch rates less than $3$\% towards both the centerline and the outer boundary.}  The dimensions of and number of grid points in the computational domain for each computation are summarized in Table~\ref{table:domain}.
...
\section{\textcolor{r2}{Supplementary Data}}

\textcolor{r2}{The constant nonunity Lewis numbers adopted in the current study are summarized in Table.~\ref{table:Lewis}.}
...
\begin{table*}
  \caption{\textcolor{r2}{Constant nonunity Lewis numbers adopted in the current study.}}
  \label{table:Lewis}
  \centering
  \normalsize
  ...
  \begin{tabular}{ll}
    ...
    CH$_3$OCH$_3$ &        $1.665$     \\
    CH$_3$OCH$_2$ &        $1.658$     \\
    CH$_3$OCH$_2$O &       $1.909$     \\
    CH$_3$OCHO &        $1.812$     \\
    CH$_3$OCO &         $1.807$     \\
    CH$_3$OCH$_2$O$_2$ &      $1.806$     \\
    CH$_3$OCH$_2$OH &      $1.751$     \\
    CH$_2$OCH$_2$O$_2$H &     $1.806$     \\
    O$_2$CH$_2$OCH$_2$O$_2$H &   $1.881$     \\
    HO$_2$CH$_2$OCHO &     $1.847$      \\
    OCH$_2$OCHO &       $1.800$     \\
    HOCH$_2$OCO &       $1.800$     \\
    HOCH$_2$O &         $1.327$     \\
    HCOOH &          $1.627$     \\
