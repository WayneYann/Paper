...
set mytics 0
unset key
set label at 0.19,0.4e5 "Ethylene: solid"
set label at 0.19,1.25e4 "Ethylene/Hydrogen: dashed"
set arrow from 0.11,10 to 0.11,1e5 nohead lw 1 lc -1 lt 2
set arrow from 0.18,10 to 0.18,1e5 nohead lw 1 lc -1
...
set arrow from 0,0.06103 to 0.5,0.06103 nohead lw 1 lc -1 lt 2
set arrow from 0,0.06366 to 0.5,0.06366 nohead lw 1 lc -1
