...
\begin{align*}
  2 C_5H_5 &\longrightarrow C_{10}H_8 + 2 H\\
  C_9H_7 + CH_3 &\longrightarrow C_{10}H_8 + 2 H.
\end{align*}
...
%  \hspace{-0.4in}
  ...
  \normalsize
  \caption{\textcolor{red}{Fuel specific pathways for C$_3$H$_6$ and A-C$_3$H$_5$ formation at the strain rate of $16$ s$^{-1}$ and $X_{O_2}=0.2$. From left to right: $n$-heptane, $n$-butanol, and methyl butanoate.  The number indicates the relative contribution (in percentages) to the formation of the pointed species.}}
