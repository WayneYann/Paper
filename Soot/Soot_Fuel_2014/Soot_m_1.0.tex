...
\begin{figure}[ht]
  ...
  \scriptsize
  \vspace{-0.1in}
  \includegraphics[trim=4mm 8mm 30mm 20mm, clip=true, width=0.4\textwidth]{Thermal.png}
  \normalsize
  \vspace{-0.1in}
